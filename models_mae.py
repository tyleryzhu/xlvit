...
class MaskedAutoencoderViT(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3,
                 ...
                 mlp_ratio=4., norm_layer=nn.LayerNorm, norm_pix_loss=False, flash_attn=False):
        super().__init__()
        ...
        self.blocks = nn.ModuleList([
            Block(embed_dim, num_heads, mlp_ratio, qkv_bias=True,
                  qk_scale=None, norm_layer=norm_layer, flash_attn=flash_attn)
        ...
        self.decoder_blocks = nn.ModuleList([
            Block(decoder_embed_dim, decoder_num_heads, mlp_ratio,
                  qkv_bias=True, qk_scale=None, norm_layer=norm_layer, flash_attn=flash_attn)
...
# Paper also recommends using smaller decoder for ViT-Tiny
# https://arxiv.org/abs/2205.14443

# * Changes from typical ViT-Tiny
# *     num_heads: 3-> 12
# *     decoder_embed_dim: 512 -> 86
# *     decoder_depth: 8 -> 1
# *     decoder_num_heads: 16 -> 3
...
def mae_vit_tiny_flash(**kwargs):
    model = MaskedAutoencoderViT(
        patch_size=16, embed_dim=192, depth=12, num_heads=12,
        decoder_embed_dim=96, decoder_depth=1, decoder_num_heads=3,
        mlp_ratio=4, norm_layer=partial(nn.LayerNorm, eps=1e-6), flash_attn=True,
        **kwargs)
    return model
...
mae_vit_tiny_patch16 = mae_vit_tiny_patch16_dec96d1b  # decoder: 96 dim, 1 blocks
