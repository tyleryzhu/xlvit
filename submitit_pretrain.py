...
def parse_args():
    ...
    parser.add_argument("--timeout", default=60 * 24 * 5,
                        type=int, help="Duration of the job")
    parser.add_argument(
        "--job_dir", default="", type=str, help="Job dir. Leave empty for automatic."
    )
    parser.add_argument(
        "--master_port", default=2345, type=int, help="Master port for slurm."
    )
    ...
    parser.add_argument(
        "--nodelist", default=None, type=str, help="List of nodes"
    )
    parser.add_argument(
        "--qos",
        default="medium",
