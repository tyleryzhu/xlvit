...
def get_args_parser():
    ...
    parser.add_argument("--skip_first", default=None,
                        type=int, help="Number of tokens to skip computing loss on.")
    ...
    # Dataset parameters
    parser.add_argument(
        "--data_path", default="/home/group/ilsvrc", type=str, help="dataset path")
    ...
    parser.add_argument("--wandb", default=None,
                        help="Use wandb to log runs, needs exp name.")
...
def main(args):
    ...
    transform_train = transforms.Compose([
        transforms.RandomResizedCrop(args.input_size, scale=(
            0.08, 1.0), interpolation=3),  # 3 is bicubic
    ...
    if args.skip_first is not None:
        model = models.__dict__[args.model](
            norm_pix_loss=args.norm_pix_loss, skip_first=args.skip_first)
    else:
